...
Key Features:
- Multiple solver methods: IPF, IPF-DSB, Malliavin, IMF, Score-Based, Doob,
  RKHS, FBSDE
- Distinct representations: Score, Drift, Control, Potential, Kernel, Particle
...
- Non-neural methods for interpretable solutions (Doob, RKHS)
...
-    SBProblem
    ...
    SBSolver
     ├─ representation: Score | Drift | Control | Potential | Kernel
...
def list_solvers() -> dict:
    ...
    return {
        ...
        'IPFDSBSolver': {
            ...
            'neural': True,
            'description': 'DSB-style IPF mean-map solver',
        },
        'DSBMSolver': {
            'representation': 'drift',
            'neural': True,
            'description': 'Diffusion Schrodinger Bridge Matching solver',
        },
        'FBSDESolver': {
...
def get_solver(
    ...
    **kwargs,
    ...
    solvers = {
        ...
        'ipf_dsb': IPFDSBSolver,
        'dsb': IPFDSBSolver,
        'diffusion_sb': IPFDSBSolver,
        'dsbm': DSBMSolver,
        'diffusion_bridge_matching': DSBMSolver,
...
__all__ = [
    ...
    'IPFDSBSolver', 'IPFDSBConfig', 'DSBSolver', 'DSBConfig',
    'DSBMSolver', 'DSBMConfig',
    'MalliavinScoreSolver',
    'MalliavinBridgeSolver', 'MalliavinConfig',
    'MalliavinAdjointConfig', 'MalliavinAdjointInnerSolver',
    'ValueOnlyCost',
    'MAMBridgeConfig', 'MAMBridgeSolver', 'ValueOnlyRunningPotential',
