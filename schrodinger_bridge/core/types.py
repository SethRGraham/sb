...
class RepresentationType(Enum):
    ...
    DRIFT = auto()         # Learned transition mean maps / drifts
...
class TrainingConfig:
    ...
    Attributes:
        ...
        checkpoint_dir: Directory where model checkpoints are written. If
            None, checkpointing is disabled.
        checkpoint_prefix: Filename prefix for saved checkpoints.
        save_final_checkpoint: Whether to write a final checkpoint after
            training completes when checkpoint_dir is set.
