...
def _(mo):
    ...
    **An Interactive Guide Using the `schrodinger_bridge` Library**
    ...
    ## Part III: Advanced Constraints
    7. **Marginal SB** — Intermediate marginal constraints

    ## Part IV: Applications
    8. **Synthetic Data Generation** — Creating plausible intermediate states
    9. **Visualization & Diagnostics** — Evaluating solution quality
...
def _(mo):
    ...
    **Example scenarios:**
    - Sensor networks: Field measurements at multiple observation times
...
def _(mo):
    ...
    ### 8.1 Why Schrödinger Bridges for Synthetic Data?
    ...
    | **Robotics** | Start pose | Goal pose | Feasible stochastic motion plans |
...
def _(mo):
    ...
    5. **Need intermediate constraints?** → `MarginalSBSolver`
